...
class UserLoginStateTests: XCTestCase {
    ...
    func testLoggedIn() {
        ...
        XCTAssertNotEqual(userLoginState.user, User(userName: "user1", email: "user2@users.com", phone: "123456789"))
        XCTAssertNotEqual(userLoginState.user, User(userName: "user1", email: "user1@users.com", phone: "123456781"))
